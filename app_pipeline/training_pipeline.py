...
import sys
from app_entity import DataIngestionArtifact, DataValidationArtifact, DataTransformationArtifact,DataIngestionConfig, ModelTrainerArtifact, ModelEvaluationArtifact, ModelPusherArtifact
from app_src import DataIngestion, DataValidation, DataTransformation, ModelTrainer, ModelEvaluation, ModelPusher
...
class TrainingPipeline:
    ...
    def start_training_pipeline(self):
        try:
            ...
            model_evaluation_artifact = self.start_model_evaluation( data_ingestion_config = self.app_config.get_data_ingestion_config(),
                                                                    data_validation_artifact=data_validation_artifact,
                                                                    model_trainer_artifact=model_trainer_artifact)
